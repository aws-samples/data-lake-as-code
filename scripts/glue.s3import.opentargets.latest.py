...
for table in tables:
  ...
  paritionList = []
  responseGetPartitions = client.get_table(DatabaseName=glue_database, Name=table)
  for partitionDict in responseGetPartitions['Table']['PartitionKeys']:
    paritionList.append(partitionDict['Name'])
